...
async def main(
    ...
    url: Optional[str] = "http://127.0.0.1:2024",
    ...
    print("In cron job set main function...")
    ...
    return cron
# uv run -m src.email_assistant.tools.gmail.setup_cron --email=chaitanyabj@gmail.com --url "http://127.0.0.1:2024"
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="*/2 * * * *",
        help="Cron schedule expression (default: every 2 minutes)",
    )
    parser.add_argument(
        "--graph-name",
        type=str,
        default="email_assistant_gmail",
